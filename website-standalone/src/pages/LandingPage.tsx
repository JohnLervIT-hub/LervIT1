        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <button onClick={() => scrollToSection('ai-technology')} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                AI Technology
              </button>
              <button onClick={() => scrollToSection('pricing')} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                Pricing
              </button>
              <button onClick={() => scrollToSection('for-movers')} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                For Movers
              </button>
            </div>
            ...
            <div className="hidden md:flex items-center gap-3">
              <a href="https://lervit.com/login">
                <Button variant="ghost" size="sm" data-testid="button-login">
                  Log In
                </Button>
              </a>
              <a href="https://lervit.com/signup">
            ...
            <div className="flex md:hidden items-center gap-2">
              <a href="https://lervit.com/request-move">
                ...
                <SheetContent side="right" className="w-80">
                  ...
                  <div className="mt-8 space-y-6">
                    <div className="space-y-4">
                      ...
                      <button 
                        onClick={() => scrollToSection('for-movers')}
                        className="block text-lg font-medium hover:text-primary transition-colors"
                      >
                        For Movers
                      </button>
                    ...
                    <div className="border-t pt-6 space-y-3">
                      <a href="https://lervit.com/login" onClick={() => setMobileMenuOpen(false)}>
                        <Button variant="outline" className="w-full">
                          Log In
                        </Button>
                      </a>
                      <a href="https://lervit.com/signup" onClick={() => setMobileMenuOpen(false)}>
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-3 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <button onClick={() => scrollToSection('ai-technology')}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Card key={index} className={feature.highlight ? 'border-primary' : ''}>
                <CardContent className="pt-8 pb-6 px-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li><a href="https://lervit.com/support" className="hover:text-foreground transition-colors">Help Center</a></li>
