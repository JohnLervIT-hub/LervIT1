...
\restrict uBJzifKxInFhb2Pzkey7aA4qf5eJCLRCeQ1Tf7A7M0KCNac3EYj1iFwQyzKFM3s
...
--
-- Name: voice_webhook_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.voice_webhook_events_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: voice_webhook_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.voice_webhook_events_id_seq OWNED BY public.voice_webhook_events.id;
...
--
-- Name: voice_webhook_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.voice_webhook_events ALTER COLUMN id SET DEFAULT nextval('public.voice_webhook_events_id_seq'::regclass);
...
0000_silky_mordo	2026-09-01 08:08:23.620449+00
0001_promo_code_uses	2026-09-01 08:08:23.654008+00
0002_sprint5_features	2026-09-01 08:08:23.683773+00
0003_sprint6_features	2026-09-01 08:08:23.713728+00
0004_referral_columns	2026-09-01 08:08:23.743032+00
0004_telnyx_voice_center	2026-09-01 08:19:32.095752+00
\.
...
COPY public.voice_webhook_events (id, event_id, event_type, payload, processed, retry_count, created_at, processed_at) FROM stdin;
\.
...
--
-- Name: voice_webhook_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.voice_webhook_events_id_seq', 1, false);
...
--
-- Name: voice_webhook_events voice_webhook_events_event_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.voice_webhook_events
    ADD CONSTRAINT voice_webhook_events_event_id_key UNIQUE (event_id);
...
\unrestrict uBJzifKxInFhb2Pzkey7aA4qf5eJCLRCeQ1Tf7A7M0KCNac3EYj1iFwQyzKFM3s
