...
*   **UI/UX:** Industry-standard mobile-first design following Uber/DoorDash/TaskRabbit patterns. Brand colors: Orange (#FF6A00) for primary CTAs, Deep Teal (#004C4C) for accents. Card-based layouts, 44px+ touch targets, fixed bottom CTAs, smooth animations, and responsive breakpoints (375px, 414px, 430px, 768px+). Role-based navigation, protected routes, customer price transparency with detailed breakdowns, and intuitive booking flow.
