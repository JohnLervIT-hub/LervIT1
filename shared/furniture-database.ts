...
export const FURNITURE_DATABASE: FurnitureItem[] = [
  ...
  // ===== NEW HEAVY ITEMS — MANUFACTURER-VERIFIED SPECS (2024/2025) =====
  {
    item_id: 'FRIDGE_FRENCH_4DOOR_001',
    name: 'French door refrigerator (4-door, large)',
    category: 'Appliance',
    subcategory: 'Refrigerator',
    keywords: ['refrigerator', 'fridge', 'french door', '4-door', 'four door', 'samsung', 'lg', 'instaview', 'smart', 'large', 'double door', 'french double door'],
  ...
  },
  {
    ...
    category: 'Electronics',
    subcategory: 'TV',
    keywords: ['tv', 'television', '82', '82-inch', 'extra large', 'screen', 'qled', 'samsung'],
  ...
  },
  {
    ...
    category: 'Electronics',
    subcategory: 'TV',
    keywords: ['tv', 'television', '86', '86-inch', 'extra large', 'screen', 'qned', 'lg', 'sony'],
  ...
  },
  {
    ...
    category: 'Electronics',
    subcategory: 'TV',
    keywords: ['tv', 'television', '98', '98-inch', 'massive', 'giant screen', 'cinema', 'samsung', 'lg', 'neo qled'],
  ...
  {
    item_id: 'PIANO_BABY_GRAND_001',
    name: 'Baby grand piano',
    category: 'Other',
    subcategory: 'Piano',
    keywords: ['piano', 'baby grand', 'grand piano', 'music', 'instrument', 'yamaha', 'steinway', 'kawai', 'C1X', 'model S'],
  ...
  {
    item_id: 'PIANO_GRAND_001',
    name: 'Grand piano (concert / full size)',
    category: 'Other',
    subcategory: 'Piano',
  ...
  {
    item_id: 'HOT_TUB_6P_001',
    name: 'Hot tub / Spa (6-person)',
    category: 'Other',
    subcategory: 'Hot Tub',
    keywords: ['hot tub', 'spa', 'jacuzzi', '6-person', 'six person', 'outdoor', 'patio', 'jets', 'hydrotherapy'],
  ...
  {
    item_id: 'HOT_TUB_4P_001',
    name: 'Hot tub / Spa (4-person)',
    category: 'Other',
    subcategory: 'Hot Tub',
    keywords: ['hot tub', 'spa', 'jacuzzi', '4-person', 'four person', 'outdoor', 'patio', 'jets', 'compact'],
  ...
  {
    item_id: 'GUN_SAFE_LARGE_001',
    name: 'Gun safe (large, 30+ gun capacity)',
    category: 'Other',
    subcategory: 'Safe',
  ...
  {
    item_id: 'GUN_SAFE_MEDIUM_001',
    name: 'Gun safe (medium, 12-24 gun capacity)',
    category: 'Other',
    subcategory: 'Safe',
    keywords: ['gun safe', 'safe', 'firearm', 'liberty', 'stack-on', 'vault', 'security', 'steel', 'medium', 'rifle'],
  ...
  {
    item_id: 'POOL_TABLE_8FT_001',
    name: 'Pool table / Billiard table (8-foot)',
    category: 'Other',
    subcategory: 'Recreation',
    keywords: ['pool table', 'billiard', 'snooker', '8-foot', 'brunswick', 'slate', 'recreation', 'game room'],
  ...
  {
    item_id: 'POOL_TABLE_9FT_001',
    name: 'Pool table / Billiard table (9-foot)',
    category: 'Other',
    subcategory: 'Recreation',
    keywords: ['pool table', 'billiard', 'snooker', '9-foot', 'regulation', 'brunswick', 'slate', 'recreation', 'game room'],
  ...
  {
    item_id: 'HOME_GYM_001',
    name: 'Home gym / Multi-station weight machine',
    category: 'Other',
    subcategory: 'Fitness',
    keywords: ['home gym', 'weight machine', 'multi-station', 'bowflex', 'life fitness', 'cable', 'strength', 'lat pulldown'],
  ...
  {
    item_id: 'BED_ADJUSTABLE_KING_001',
    name: 'King adjustable bed base',
    category: 'Bed',
    subcategory: 'Adjustable Base',
    keywords: ['adjustable', 'bed base', 'king', 'tempur-pedic', 'sleep number', 'motorized', 'ergo', 'smart', 'massage', 'zero gravity'],
  ...
  {
    item_id: 'BED_ADJUSTABLE_QUEEN_001',
    name: 'Queen adjustable bed base',
    category: 'Bed',
    subcategory: 'Adjustable Base',
    keywords: ['adjustable', 'bed base', 'queen', 'tempur-pedic', 'sleep number', 'motorized', 'ergo', 'smart', 'massage'],
  ...
  {
    item_id: 'PINBALL_MACHINE_001',
    name: 'Pinball machine',
    category: 'Other',
    subcategory: 'Arcade',
    keywords: ['pinball', 'arcade', 'stern', 'williams', 'bally', 'game', 'coin-op', 'entertainment', 'retro'],
  ...
  {
    item_id: 'ARCADE_CABINET_001',
    name: 'Arcade game cabinet (upright)',
    category: 'Other',
    subcategory: 'Arcade',
    keywords: ['arcade', 'game', 'cabinet', 'upright', 'coin-op', 'midway', 'atari', 'classic', 'retro', 'pac-man'],
  ...
  {
    item_id: 'MOTORCYCLE_001',
    name: 'Motorcycle (standard / cruiser)',
    category: 'Other',
    subcategory: 'Vehicle',
    keywords: ['motorcycle', 'bike', 'motorbike', 'honda', 'kawasaki', 'harley', 'davidson', 'yamaha', 'suzuki', 'cruiser'],
