...
export function getVehicleRecommendationWithCategory(
  ...
  // Luggage override: Bags and suitcases always fit in car
  if (normalizedCategory === 'luggage' && totalVolumeFt3 <= 20) {
    console.log(`[Vehicle] Luggage category override: ${totalVolumeFt3} ft³ → SUV`);
    return 'car';
  }
