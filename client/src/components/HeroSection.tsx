        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-card/95 backdrop-blur-sm p-6 md:p-8 rounded-xl border border-card-border shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 py-1 text-center">
                ...
                <span className="text-sm font-semibold text-foreground shrink-0">4.9</span>
                <span className="text-sm text-muted-foreground shrink-0">· 200+ moves in Calgary</span>
              </div>
