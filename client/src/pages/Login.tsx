...
function LervitBackground() {
  return (
    <div className="absolute inset-0 z-0">
      ...
      <Icon kind="truck" className="absolute left-[6%] top-[18%] w-12 sm:w-16 md:w-20 animate-floatSlow" glow="blue" />
      <Icon kind="pin" className="absolute right-[10%] top-[8%] w-10 sm:w-12 md:w-16 animate-pulseSoft hidden sm:block" glow="pink" />
      <Icon kind="pin" className="absolute left-[10%] bottom-[12%] w-10 sm:w-12 md:w-16 animate-pulseSoft" glow="blue" />
      <Icon kind="box" className="absolute right-[16%] top-[36%] w-14 sm:w-18 md:w-24 animate-float hidden sm:block" glow="blue" />
      <Icon kind="truck" className="absolute right-[8%] bottom-[10%] w-12 sm:w-16 md:w-20 animate-floatSlow" glow="orange" />
