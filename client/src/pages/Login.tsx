...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-50/80 via-slate-50 to-indigo-50/60 dark:bg-[#050A14] dark:from-transparent dark:via-transparent dark:to-transparent">
      ...
      <Card className="w-full max-w-md bg-card dark:bg-[rgba(10,14,24,0.65)] border border-white/50 dark:border-white/[0.08] dark:backdrop-blur-[14px] shadow-[0_8px_30px_rgba(0,0,0,0.12),0_4px_10px_rgba(0,0,0,0.06)] dark:shadow-[0_25px_80px_rgba(0,0,0,0.55)] mx-2 sm:mx-0">
