...
export default function PartnerBookings() {
  ...
  return (
    <PartnerLayout>
      ...
      <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 px-6 py-7">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/75 mt-0.5">
                {counts.pending > 0
                  ? <><span className="font-semibold text-white">{counts.pending} new</span> booking{counts.pending !== 1 ? "s" : ""} awaiting response</>
